...
class ParserTest(TestCase):
    ...
    def test_ok(self):
        ...
        lines.append(StatementLine(date='30-12-2019', memo='Conversie geldmarktfonds: Koop 0,000016 @ 9.961,4715 EUR MORGAN STANLEY EUR LIQUIDITY FUND (LU1959429272)', amount=''))
        lines.append(StatementLine(date='27-12-2019', memo='Dividend VANECK AEX (NL0009272749)', amount='0,19'))
        lines.append(StatementLine(date='27-12-2019', memo='Dividendbelasting VANECK AEX (NL0009272749)', amount='-0,03'))
        lines.append(StatementLine(date='26-09-2019', memo='Conversie geldmarktfonds: Koop 0,000039 @ 9.975,9152 EUR MORGAN STANLEY EUR LIQUIDITY FUND (LU1959429272)', amount=''))
        lines.append(StatementLine(date='25-09-2019', memo='Dividend VANECK AEX (NL0009272749)', amount='0,46'))
        lines.append(StatementLine(date='25-09-2019', memo='Dividendbelasting VANECK AEX (NL0009272749)', amount='-0,07'))
        lines.append(StatementLine(date='27-06-2019', memo='Conversie geldmarktfonds: Koop 0,001337 @ 9.986,9062 EUR MORGAN STANLEY EUR LIQUIDITY FUND (LU1959429272)', amount=''))
        lines.append(StatementLine(date='26-06-2019', memo='Dividend VANECK AEX (NL0009272749)', amount='1,06'))
        lines.append(StatementLine(date='26-06-2019', memo='Dividendbelasting VANECK AEX (NL0009272749)', amount='-0,16'))
        lines.append(StatementLine(date='26-06-2019', memo='Dividend VANECK ESG EW (NL0010408704)', amount='4,40'))
        ...
        lines.append(StatementLine(date='19-06-2019', memo='Verkoop 10 @ 55,92 EUR ISHARES AEX (IE00B0M62Y33)', amount='559,20'))
        lines.append(StatementLine(date='04-06-2019', memo='Rente', amount='-0,01'))
        lines.append(StatementLine(date='03-05-2019', memo='Rente', amount='-0,01'))
        lines.append(StatementLine(date='01-04-2019', memo='Rente', amount='-0,02'))
        lines.append(StatementLine(date='27-03-2019', memo='Dividend VANECK AEX (NL0009272749)', amount='0,25'))
        lines.append(StatementLine(date='27-03-2019', memo='Dividendbelasting VANECK AEX (NL0009272749)', amount='-0,04'))
        lines.append(StatementLine(date='27-03-2019', memo='Dividend VANECK ESG EW (NL0010408704)', amount='1,00'))
        lines.append(StatementLine(date='27-03-2019', memo='Dividendbelasting VANECK ESG EW (NL0010408704)', amount='-0,15'))
        lines.append(StatementLine(date='27-03-2019', memo='Dividend ISHARES AEX (IE00B0M62Y33)', amount='1,97'))
        # in USD
